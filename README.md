...
|------|---------------|--------|------------|
| 1    | Aug 21, 26    | Intro<sup>[1](doc/Welcome%20to%20SWE4S.pdf "Course Intro")</sup>, Setup<sup>[1](doc/Command%20Line.pdf "Command Line Primer"), [2](doc/Shell%20Scripts.pdf "Shell Scripts"), [3](doc/Development%20Environment.pdf "Development Environment"), [4](doc/Conda.pdf "Conda/Mamba"), [5](course-material/python-refresher/us-counties.csv "US Counties Data")</sup>, GitHub<sup>[1](doc/Version%20Control%2C%20Git%2C%20and%20GitHub-slides.pdf "Intro to Version Control"), [2](doc/Version%20Control%2C%20Git%2C%20and%20GitHub.pdf "Version Control, Git, and GitHub"), [3](doc/Using%20SSH%20Keys%20with%20GitHub.pdf "Using SSH Keys with GitHub")</sup>, GitHub Classroom<sup>[1](doc/GitHub%20Classroom.pdf)</sup> | [1](assignments/Assignment%201_%20GitHub%20Classroom.pdf) |
| 2    | Aug 28, Sep 2 | Python<sup>[1](doc/Python%20Refresher.pdf "Python Refresher"), [2](https://github.com/swe4s/lectures/tree/main/src/python_refresher "Example Python scripts")</sup> | [2](assignments/Assignment%202_%20Python%20Refresher.pdf) |                        
...
| 10   | Oct 21, 23    | Workflow<sup>[1](doc/Piplines%20and%20workflows.pdf)</sup> | [8](assignments/Assignment%208_%20Workflow%20Language.pdf)
| 11   | Oct 28, 30    | Hash tables<sup>[1](doc/Hash%20Tables.pdf)</sup>, Benchmarking<sup>[1](doc/Profiling%20and%20Benchmarking.pdf)</sup> | [9](assignments/Assignment%209_%20Hash%20Tables.pdf)|
